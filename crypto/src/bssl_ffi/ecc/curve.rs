...
use core::{convert, ffi, mem, ptr, marker};
...
impl BsslBnCtx {
    ...
    fn as_mut_ptr(&mut self) -> *mut bssl_bare_sys::BN_CTX {
        self.ctx
    }
}
...
impl BsslBn {
    ...
    fn as_ptr(&self) -> *const bssl_bare_sys::BIGNUM {
        self.bn as *const bssl_bare_sys::BIGNUM
    }

    fn as_mut_ptr(&mut self) -> *mut bssl_bare_sys::BIGNUM {
        self.bn
    }
    ...
    fn to_be_bytes(&self, dst: &mut cmpa::MpMutBigEndianUIntByteSlice<'_>) -> Result<(), CryptoError> {
    ...
    fn try_from_cmpa_mp_uint<T: cmpa::MpUIntCommon>(value: &T) -> Result<Self, CryptoError> {
