...
/// MGF1 mask generation function specified in RFC8017.
...
impl RFC8017Mgf1 {
    /// Create a new RFC8017Mgf1 instance.
    ///
    /// # Arguments:
    ///
    /// * `hash_alg` - The `MGF1()`'s underlying hash algorithm.
    /// * `seed` - The `seed` as defined in the `MFG1()` specification.
    /// * `n_total_output_bits` - The total number of output bits to get
    ///   collectively generated by the created instance.
    pub fn new(
...
impl FixedBlockOutputKdf for RFC8017Mgf1 {
...
#[cfg(test)]
fn test_rfc8017_mgf1_common(hash_alg: tpm2_interface::TpmiAlgHash, expected: &[u8]) {
    extern crate alloc;
    use alloc::vec;

    use super::{BufferedFixedBlockOutputKdf, VariableChunkOutputKdf};
    ...
    // full last block.
    let mut kdf =
        BufferedFixedBlockOutputKdf::new(RFC8017Mgf1::new(hash_alg, block_len + 1, &TEST_SEED).unwrap()).unwrap();

    let mut generated = vec![0u8; expected.len()];
    kdf.generate_chunk(io_slices::SingletonIoSliceMut::new(&mut generated).map_infallible_err())
        .unwrap();
...
fn test_rfc8017_mgf1_sha1() {
    ...
    test_rfc8017_mgf1_common(tpm2_interface::TpmiAlgHash::Sha1, &expected);
}
...
fn test_rfc8017_mgf1_sha256() {
    ...
    test_rfc8017_mgf1_common(tpm2_interface::TpmiAlgHash::Sha256, &expected);
}
...
fn test_rfc8017_mgf1_sha384() {
    ...
    test_rfc8017_mgf1_common(tpm2_interface::TpmiAlgHash::Sha384, &expected);
}
...
fn test_rfc8017_mgf1_sha512() {
    ...
    test_rfc8017_mgf1_common(tpm2_interface::TpmiAlgHash::Sha512, &expected);
}
...
fn test_rfc8017_mgf1_sha3_256() {
    ...
    test_rfc8017_mgf1_common(tpm2_interface::TpmiAlgHash::Sha3_256, &expected);
}
...
fn test_rfc8017_mgf1_sha3_384() {
    ...
    test_rfc8017_mgf1_common(tpm2_interface::TpmiAlgHash::Sha3_384, &expected);
}
...
fn test_rfc8017_mgf1_sha3_512() {
    ...
    test_rfc8017_mgf1_common(tpm2_interface::TpmiAlgHash::Sha3_512, &expected);
}
